...
export function Header() {
  return (
    <header className="flex h-24 items-center px-8 bg-white shadow-lg">
      ...
      <button className="w-44 bg-teal-600 hover:bg-teal-500 transition-colors text-white rounded-lg px-5 py-2 text-2xl leading-tight cursor-pointer">
        Играть
      </button>
      <button className="ml-auto flex items-center gap-2 text-start cursor-pointer text-teal-600 hover:text-teal-500 transition-colors">
